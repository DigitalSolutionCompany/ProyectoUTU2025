...
const DB_NAME = 'bd_juego'; // Nombre de la base de datos a la que queremos conectarnos
...
class Database {
    ...
    private $conexion; // Aquí se guardará el objeto de conexión PDO

    // Método público para establecer la conexión a la base de datos
    public function connect() {
        $this->conexion= null; // Inicializamos la conexión como null
